...
def album_detail(request, album_id):
    ...
    if request.method == "POST":
        ...
        if review_form.is_valid():
            ...
            messages.error(request, "Failed to add review. Please correct the errors below.")
    else:
    ...
    if request.user == review.author:
        ...
        if request.method == 'POST':
            if form.is_valid():
                ...
                messages.error(request, "Failed to update review. Please correct the errors below.")
        context = {
            'album': album,
            'form': form,
        }
